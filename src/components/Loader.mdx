...
The progress indicator can be configured either by `props` when you want to customize a _single instance_ of a `<loader>` or in `css`/`scss` when you want to customize the _overall look and feel_ of the component. For example if you want to change the progress size you can either have a css like:
